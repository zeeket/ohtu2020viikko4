...
public class VerkkokauppaTest {
    ...
    public void kahdenOstoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaan() {
        ...
        // määritellään että tuote numero 2 on peruna jonka hinta on 1 ja saldo 100
    ...
    @Test
    public void kahdenOstoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaanKunToinenLoppu() {
        // luodaan ensin mock-oliot
        ...
        // määritellään että tuote numero 2 on peruna jonka hinta on 1 ja saldo 
